...
const navigation: NavItem[] = [
  ...
  { label: "Help Center", icon: "?", target: "help-center", href: "/help" },
];
    ...
    <main className="saasApp" id="top">
      ...
      <section className="saasMain">
        ...
        <div className="saasContent">
          ...
          <section className="controlPanel" id="help-center"><div className="controlCopy"><span className="eyebrow">HELP CENTER</span><h2>Using Inbox Outlaw</h2><p>Search setup instructions, inbox actions, reports, account controls, and scam-safety guidance.</p></div><div className="controlActions"><a className="button secondary" href="/help">Open full Help Center</a><a className="button secondary" href="mailto:support@inboxoutlaw.app">Contact support</a></div><div className="controlStatus">For suspicious messages, do not click links, send money, share passwords, or provide verification codes until the sender is independently verified.</div></section>
        </div>
      </section>
    </main>
  );
