...
export type InboxSummary = { total: number; scams: number; opportunities: number; handled: number };
...
export type ActivityLogEntry = {
  id: string;
  type: 'login' | 'manual_classification' | 'gmail_connected' | 'gmail_disconnected' | 'gmail_synced' | 'email_reviewed' | 'sender_rule_updated' | 'logout';
  message: string;
